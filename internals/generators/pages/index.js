      ...
      validate: value => {
        if (/.+/.test(value)) {
          return componentExists(value)
            ? 'A component or pages with this name already exists'
            : true;
        }
  ...
  actions: data => {
    ...
    switch (data.type) {
      case 'Stateless Function': {
        componentTemplate = './pages/stateless.js.hbs';
        break;
      }
      default: {
        componentTemplate = './pages/class.js.hbs';
      }
    }
    ...
    const actions = [
      ...
      {
        type: 'add',
        path: '../../app/pages/{{properCase name}}/tests/index.test.ts',
        templateFile: './pages/test.js.hbs',
        abortOnFail: true,
      },
    ];
    ...
    if (data.wantLoadable) {
      actions.push({
        type: 'add',
        path: '../../app/modules/{{properCase name}}/Loadable.ts',
